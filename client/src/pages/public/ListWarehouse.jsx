      ...
      <div className="section">
        <div className="container-narrow">
          <div className="card text-center" style={{ padding: '48px 32px' }}>
            ...
            <h2 className="mb-2">Warehouse submitted successfully for admin verification</h2>
            <p className="text-muted mb-3">Our admin team will review your listing. Once verified, it will be published on the platform.</p>
